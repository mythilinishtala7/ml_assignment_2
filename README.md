...
Logistic Regression performed strongly with a high AUC score (0.91), indicating good probability estimation. It achieved balanced precision and recall after proper feature scaling.
...
Naive Bayes achieved very high recall (0.95), meaning it identified most high-income individuals. However, its precision was very low, leading to poor overall accuracy and MCC. This reflects the strong independence assumption of Naive Bayes.
